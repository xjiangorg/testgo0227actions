...
export IMAGE_URL=${IMAGE_URL-quay.io/quay_xjiang/testgo0227actions:$CI_TYPE-$TAG}
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rosa.xjiang0225417.4atg.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.rosa.xjiang0225417.4atg.p3.openshiftapps.com}
